...
Private Sub ImageGen(Path As String)
    ...
    For Z = 0 To picImage.ScaleHeight - 1
        ...
        CopyMemory Line24(0), ByVal Ptr24, BmpWidth * 3
            ...
            '循环中浮点计算通病
                If Version1_13.Checked Then
                Print #1, "particle minecraft:dust " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 " & XOff & " " & Format(Round(0.05 + YOff + 0.1 * Z, 2), ".00") & " " & Format(Round(0.1 * X + 0.05 + ZOff, 2), ".00") & " ~ ~ ~ 1 0 force"
                Else
                Print #1, "particle reddust " & XOff & " " & Round(0.05 + YOff + 0.1 * Z, 1) & " " & Round(0.1 * X + 0.05 + ZOff, 1) & " " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 0 force"
                End If
            ElseIf DirY.Value Then
                If Version1_13.Checked Then
                    Print #1, "particle minecraft:dust " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 " & Format(Round(0.05 + XOff - 0.1 * X, 2), ".00") & " " & YOff & " " & Format(Round(0.1 * Z + 0.05 + ZOff, 2), ".00") & " ~ ~ ~ 1 0 force"
                Else
                    Print #1, "particle reddust " & Round(0.05 + XOff - 0.1 * X, 1) & " " & YOff & " " & Round(0.1 * Z + 0.05 + ZOff, 1) & " " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 0 force"
                End If
            ElseIf DirZ.Value Then
                If Version1_13.Checked Then
                    Print #1, "particle minecraft:dust " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 " & Format(Round(0.1 * X + 0.05 + XOff, 2), ".00") & " " & Format(Round(0.05 + YOff + 0.1 * Z, 2), ".00") & " " & ZOff & " ~ ~ ~ 1 0 force"
                Else
                    Print #1, "particle reddust " & Round(0.1 * X + 0.05 + XOff, 1) & " " & Round(0.05 + YOff + 0.1 * Z, 1) & " " & ZOff & " " & WritePix.R & " " & WritePix.G & " " & WritePix.B & " 1 0 force"
                End If
            End If
            Next
            '复制索引颜色
...
WidthBlock.Caption = txtWidth.Text / 10 & LangMsg(13)
HeightBlock.Caption = txtHeight.Text / 10 & LangMsg(13)
